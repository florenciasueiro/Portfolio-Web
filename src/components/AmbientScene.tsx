...
function Object() {
  ...
  return <Float speed={1.2} rotationIntensity={.35} floatIntensity={.5}><mesh ref={ref}><icosahedronGeometry args={[2.2, 2]} /><meshPhysicalMaterial color="#8b5cf6" wireframe transparent opacity={.2} roughness={.3} /></mesh></Float>;
}
