...
export function Hero() {
  ...
  return <section id="inicio" className="hero"><div className="hero-glow" />
    <motion.div className="hero-inner container" style={{ y, opacity }}>
      ...
      <motion.h1 initial={{ opacity: 0, y: 60, filter: "blur(16px)" }} animate={{ opacity: 1, y: 0, filter: "blur(0px)" }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}>Flor<br /><em>desarrolladora.</em></motion.h1>
